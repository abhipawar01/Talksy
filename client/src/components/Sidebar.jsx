...
const Sidebar = ({ isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    ...
    ${!isMenuOpen && 'max-md:translate-x-full'}`}>
        ...
        {/*New Chat Button*/}
        <button className='flex justify-center items-center w-full py-2 mt-10 text-white bg-gradient-to-r from-[#A456F7] to-[#7C3AED]
        ...
        dark:border-white/15 rounded-md cursor-pointer group'>
          ...
          <p className='flex-1 text-sm dark:text-primary truncate'>{user ? user.name :
            ...
            {user && <img src={assets.logout_icon} className='h-4 cursor-pointer hidden not-dark:invert 
